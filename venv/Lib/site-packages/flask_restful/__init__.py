...
class Api(object):
    ...
    :param catch_all_404s: Use :meth:`handle_error`
        to handle 404 errors throughout your apps
    ...
    def init_app(self, app):
        ...
        """
        # If apps is a blueprint, defer the initialization
        try:
    ...
    def _deferred_blueprint_init(self, setup_state):
        ...
        perform initialization with setup_state.apps :class:`flask.Flask` object.
    ...
    def error_router(self, original_handler, e):
        ...
        apps's original error handler will be dispatched.
        In the event that the error occurred in a flask-restful endpoint but
        the local handler can't resolve the situation, the router will fall
        back onto the original_handler as last resort.

        :param original_handler: the original Flask error handler for the apps
