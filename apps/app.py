...
from apps.resources.District import District, DistrictModel
from apps.resources.Doctor import Doctor, DoctorModel
...
from apps.resources.MedicalSpeciality import MedicalSpeciality, MedicalSpecialityModel
from apps.resources.Membership import MembershipDoctor, MembershipPatient
from apps.resources.Patient import Patient, PatientModel
from apps.resources.Plan import Plan, PlanModel
from apps.resources.Prescription import PrescriptionDoctor, PrescriptionPatient
from apps.resources.PrescriptionType import PrescriptionType, PrescriptionTypeModel
from apps.resources.Role import Role, RoleModel
from apps.resources.UnitsOfMeasure import UnitOfMeasure, UnitOfMeasureModel
from apps.resources.User import User, UserModel
